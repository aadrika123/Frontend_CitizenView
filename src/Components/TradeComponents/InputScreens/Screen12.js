...
function Screen12(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            allFormDataFun("ownerDetails",values);
            props.nextFun();
        },
        validationSchema
    });
                        ...
                        <div className={`grid grid-cols-12 ${bgCardColor} shadow-sm w-full md:w-1/3 p-4 py-4 md:p-4`}>
                            ...
                            <div className="form-group mb-4 md:mb-6 col-span-12 mt-4">
                                ...
                                <div className="">
                                    ...
                                    <input type="text" name='ownerName' className={`${inputStyle}`} onChange={formik.handleChange} value={formik.values.ownerName} />
                                ...
                                <div className="">
                                    ...
                                    <input type="text" name='guardianName' className={`${inputStyle}`} onChange={formik.handleChange} value={formik.values.guardianName} />
                                ...
                                <div className="">
                                    ...
                                    <input type="tel" name='mobile' className={`${inputStyle}`} onChange={formik.handleChange} value={formik.values.mobile} />
                                    <p className='text-red-500 text-xs'>{formik.touched.mobile && formik.errors.mobile ? formik.errors.mobile : null}</p>
                                </div>
                                <div className="">
                                    ...
                                    <input type="email" name='email' className={`${inputStyle}`} onChange={formik.handleChange} value={formik.values.email} />
                            ...
                            <div className="col-span-12 grid grid-cols-12 gap-x-6 mt-6">
                                ...
                                <div className="col-span-6"> <button type="button" className={`shadow-lg w-full px-6 py-4 ${nextButtonColor} text-white font-medium text-xs leading-tight  rounded  ${nextBtnHoverColor} hover:shadow-lg  focus:shadow-lg focus:outline-none focus:ring-0  active:shadow-lg transition duration-150 ease-in-out`}>Next</button></div>
                            </div>
                        </div>
                    </div>
