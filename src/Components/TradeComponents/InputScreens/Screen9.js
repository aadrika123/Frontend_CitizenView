                ...
                <div className={`grid grid-cols-12 ${bgCardColor} shadow-lg w-full md:w-1/3 p-4 py-10 md:p-10`}>
                    ...
                    <div className={`form-group mb-4 md:mb-6 col-span-12 `}>
                        <div className="form-group mb-4 md:mb-6 col-span-12 ">
                            ...
                            <input type="text" name='premisesOwner' className={`${inputStyle}`} placeholder='Name of the Premises Owner.' />
                        ...
                        <div className="form-group mb-4 md:mb-6 col-span-12">
                            ...
                            <input type="text" name='businessAddress' className={`${inputStyle}`} placeholder='Enter Business Address.' />
                        ...
                        <div className="form-group mb-4 md:mb-6 col-span-12 ">
                            ...
                            <input type="text" name='landmark' className={`${inputStyle}`} placeholder='Enter Landmark.' />
                        ...
                        <div className="form-group mb-4 md:mb-6 col-span-12 ">
                            ...
                            <input type="text" name='pincode' className={`${inputStyle}`} placeholder='Enter Pincode.' />
