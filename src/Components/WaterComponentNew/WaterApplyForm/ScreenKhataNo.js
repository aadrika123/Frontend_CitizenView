...
//    Revision - 1
//    Project - JUIDCO
//    Component  - ScreenKhataNo
//    DESCRIPTION - ScreenKhataNo compomnent 
//////////////////////////////////////////////////////////////////////////////////////
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className='p-2 md:p-10 flex justify-center items-center  overflow-hidden'>
                        <div className={`grid grid-cols-12 ${bgCardColor} shadow-lg w-full md:w-1/3 p-4 md:p-10`}>
                            <div className="col-span-12"> <h1 className={`font-bold ${titleColor} text-2xl`}>Khata No.</h1></div>
