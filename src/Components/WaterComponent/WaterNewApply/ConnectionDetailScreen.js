                        ...
                        <div className="form-group mb-4 md:mb-6 col-span-12 mt-4">
                            <div className='flex flex-row'>
                                <div className=" items-center mb-4">
                                    ...
                                    <label for="option1" className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-300">Water</label>
                                </div>
                                <div className=" items-center mb-4 ml-4">
                                    <input checked id="option2" type="radio" value="" name="propertyType" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                                    <label for="option2" className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-300">Sewerage</label>
                                </div>
                            </div>
