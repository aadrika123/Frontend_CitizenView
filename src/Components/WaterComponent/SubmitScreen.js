            ...
            <div>
                ...
                <div className='p-2 md:p-10 flex justify-center items-center  overflow-hidden'>
                    <div className={`grid grid-cols-12 ${bgCardColor} shadow-lg w-full md:w-1/3 p-4 py-10 md:p-10`}>
                        <div className="col-span-12"> <h1 className={`font-bold ${titleColor} text-lg text-center`}> Application for new water and sewerage connection</h1></div>
                        <div className="form-group mb-4 md:mb-6 col-span-12 mt-4">
                            ...
                            <div className="text-center -mt-3 ">
                                <label className="ml-2 text-sm font-medium text-gray-500 ">Thanku You For Submitting the application </label>
