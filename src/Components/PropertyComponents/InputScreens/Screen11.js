              ...
              <div className={`grid grid-cols-12 ${bgCardColor} shadow-lg w-full md:w-1/3 p-4 py-10 md:p-10`}>
                  ...
                  <div className="form-group mb-4 md:mb-6 col-span-12 mt-4">
                      <div className="flex items-center mb-4">
                          ...
                          <label for="option1" className="ml-2 text-sm font-medium text-gray-900 ">Institutional - Private</label>
                      </div>
                      <div className="flex items-center mb-4">
                          ...
                          <label for="option2" className="ml-2 text-sm font-medium text-gray-900 ">Institutial - Government</label>
                      </div>
                      <div className="flex items-center mb-4">
                          <input checked id="option2" type="radio" value="" name="residentialType" className="w-6 h-6 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                          <label for="option2" className="ml-2 text-sm font-medium text-gray-900 ">Single Owner</label>
                      </div>
                      <div className="flex items-center mb-4">
                          <input checked id="option2" type="radio" value="" name="residentialType" className="w-6 h-6 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                          <label for="option2" className="ml-2 text-sm font-medium text-gray-900 ">Multiple Owners</label>
                      </div>
