                    ...
                    <div className="form-group mb-4 md:mb-6 col-span-12 mt-4">
                        ...
                        <div className='flex'>
                            <div className="flex items-center mb-4 mx-2">
                                <input id="option1" type="radio" value="" name="residentialType" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                                <label for="option1" className="ml-2 text-sm font-medium text-gray-900 ">Male</label>
                            </div>
                            <div className="flex items-center mb-4 mx-2">
                                <input checked id="option2" type="radio" value="" name="residentialType" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                                <label for="option2" className="ml-2 text-sm font-medium text-gray-900 ">Female</label>
                            </div>
                            <div className="flex items-center mb-4 mx-2">
                                <input checked id="option3" type="radio" value="" name="residentialType" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                        ...
                        <div>
                            ...
                            <input type="text" className="form-control w-full border-l-0 rounded-l-none px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md" />
                                </div>                       
                        </div>
                        <div>
                        ...
                        <div className=''>
                            <div className="flex items-center mb-4">
                                <input id="option1" type="radio" value="" name="residentialType" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
                                <label for="option1" className="ml-2 text-sm font-medium text-gray-900 ">Husband</label>
                            </div>
                            <div className="flex items-center mb-4">
                                <input checked id="option2" type="radio" value="" name="residentialType" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600" />
