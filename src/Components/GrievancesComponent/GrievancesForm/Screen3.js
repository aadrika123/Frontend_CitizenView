          ...
          >
            ...
            <div className="col-span-12">
              ...
              <h1 className={`font-bold ${titleColor} text-2xl`}>
                Do you know the pincode ?
              </h1>
            </div>
            <div className="col-span-12">
              {" "}
              <h1 className={` ${titleColor} text-xs opacity-40`}>
                If you know the pincode of the complaint address, provide below. It will help up us identify complaint locaiton easily or you can skip and continue.
              </h1>
            </div>
